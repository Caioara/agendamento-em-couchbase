...
ax1.set_title("Agenda Flow - Throughput por operacao")
fig.tight_layout()
...
ax2.set_title("Agenda Flow - Latencia p95 por operacao")
fig.tight_layout()
...
ax3.set_title("Agenda Flow - Estimativa de armazenamento")
fig.tight_layout()
...
ax4.set_title("Agenda Flow - Checklist de vulnerabilidade")
fig.tight_layout()
